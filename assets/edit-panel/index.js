...
{ 
    ...
    //================|| Social ||================//
    //********|| Size ||********//
    root.style.setProperty('--social-size', `20px`) 
    //********|| Weight ||********//
    root.style.setProperty('--social-weight', `normal`) 


    //================|| Button ||================//
    //********|| Size ||********//
    root.style.setProperty('--button-size', `17px`) 
    //********|| Margin ||********//
    root.style.setProperty('--button-margin', `0px, 0px`) 
    //********|| Weight ||********//
    root.style.setProperty('--button-weight', `normal`) 


    //================|| Categories ||================//
    //********|| Size ||********//
    root.style.setProperty('--categories-title-size', `28px`)  
    root.style.setProperty('--categories-text-size', `16px`)  
    //********|| Weight ||********//
    root.style.setProperty('--categories-weight', `normal`) 
...
{ 
    ...
    //================|| Social ||================//
    //********|| Size ||********//
    root.style.setProperty('--social-size', `18px`) 
    //********|| Weight ||********//
    root.style.setProperty('--social-weight', `normal`) 
    ...
    //================|| Button ||================//
    //********|| Size ||********//
    root.style.setProperty('--button-size', `16px`) 
    //********|| Margin ||********//
    root.style.setProperty('--button-margin', `0px, 0px`) 
    //********|| Weight ||********//
    root.style.setProperty('--button-weight', `normal`) 
    ...
    //********|| Size ||********//
    root.style.setProperty('--categories-title-size', `28px`)  
    root.style.setProperty('--categories-text-size', `14px`)  
    //********|| Weight ||********//
    root.style.setProperty('--categories-weight', `700`) 
...
{ 
    ...
    //================|| Social ||================//
    //********|| Size ||********//
    root.style.setProperty('--social-size', `21px`) 
    //********|| Weight ||********//
    root.style.setProperty('--social-weight', `normal`)
    ...
    //================|| Button ||================//
    //********|| Size ||********//
    root.style.setProperty('--button-size', `15px`) 
    //********|| Margin ||********//
    root.style.setProperty('--button-margin', `0px, 5px`) 
    //********|| Weight ||********//
    root.style.setProperty('--button-weight', `700`) 

    
    //================|| Categories ||================//
    //********|| Size ||********//
    root.style.setProperty('--categories-title-size', `30px`)  
    root.style.setProperty('--categories-text-size', `14px`)  
    //********|| Weight ||********//
    root.style.setProperty('--categories-weight', `normal`) 
...
{ 
    ...
    //================|| Button ||================//
    //********|| Size ||********//
    root.style.setProperty('--button-size', `18px`) 
    //********|| Margin ||********//
    root.style.setProperty('--button-margin', `0px, 0px`) 
    //********|| Weight ||********//
    root.style.setProperty('--button-weight', `normal`) 
    ...
    //================|| Categories ||================//
    //********|| Size ||********//
    root.style.setProperty('--categories-title-size', `33px`)  
    root.style.setProperty('--categories-text-size', `16px`)  
    //********|| Weight ||********//
    root.style.setProperty('--categories-weight', `normal`) 
...
{ 
    ...
    root.style.setProperty('--social-size', `20px`) 
    //********|| Weight ||********//
    root.style.setProperty('--social-weight', `700`) 
    ...
    root.style.setProperty('--button-size', `16px`) 
    //********|| Margin ||********//
    root.style.setProperty('--button-margin', `0px, 2px`) 
    //********|| Weight ||********//
    root.style.setProperty('--button-weight', `700`) 
    ...
    //********|| Size ||********//
    root.style.setProperty('--categories-title-size', `28px`)  
    root.style.setProperty('--categories-text-size', `15px`)  
    //********|| Weight ||********//
    root.style.setProperty('--categories-weight', `700`) 
...
{ 
    ...
    root.style.setProperty('--button-size', `15px`) 
    //********|| Margin ||********//
    root.style.setProperty('--button-margin', `-1px, 0px`) 
    //********|| Weight ||********//
    root.style.setProperty('--button-weight', `700`) 
